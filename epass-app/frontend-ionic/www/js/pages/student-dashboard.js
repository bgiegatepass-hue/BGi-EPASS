...
Pages['student-dashboard'] = {
  ...
  _showApplyLeaveModal() {
      ...
      <ion-content class="ion-padding" style="--background:var(--bgi-bg);--padding-top:6px;--padding-bottom:8px;">
        <div style="max-width:480px;margin:0 auto;">
          ...
          <div style="margin-bottom:8px;">
            <div style="background:var(--bgi-surface);border-radius:12px;border:1px solid var(--bgi-border);padding:2px 14px 4px;">
              <div style="display:flex;justify-content:space-between;align-items:center;">
                <label style="font-size:10px;font-weight:700;color:var(--bgi-text-secondary);display:block;padding-top:4px;letter-spacing:0.5px;text-transform:uppercase;">Entry <span style="color:var(--bgi-danger);">*</span></label>
          ...
          <div style="margin-bottom:10px;">
            <div style="background:var(--bgi-surface);border-radius:12px;border:1px solid var(--bgi-border);padding:2px 14px 4px;">
              <div style="display:flex;justify-content:space-between;align-items:center;">
                <label style="font-size:10px;font-weight:700;color:var(--bgi-text-secondary);display:block;padding-top:4px;letter-spacing:0.5px;text-transform:uppercase;">Exit <span style="color:var(--bgi-danger);">*</span></label>
    ...
    modal.querySelector('#apply-submit-btn').addEventListener('click', async () => {
      ...
      if (!entryTimeVal) { 
        errorEl.style.display = 'block'; 
        errorEl.textContent = 'Please select entry time'; 
        return; 
      }
      if (!exitTimeVal) { 
        errorEl.style.display = 'block'; 
        errorEl.textContent = 'Please select exit time'; 
        return; 
      }
      if (!leaveDate) { 
        errorEl.style.display = 'block'; 
